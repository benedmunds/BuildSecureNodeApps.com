<?php
	...
	if (isset($_GET['coupon']) && !empty($_GET['coupon']))
	{
		...
		{
			$price = trim(money_format('%(#10n', $coupons[$_GET['coupon']]));
		}
	}
...
<body class="landing-page">
	...
	<section id="home" class="home boxed">
		<div class="container">
			...
			<div class="eight columns">
				<h1 class="title">
					Is your Node app <span class="title-highlight">truly secure</span>?
				</h1>
				<h2 class="title">
	...
	<section id="reviews" class="reviews boxed-mini" style="display:none;">
		...
		<div class="feature">
			<div class="container">
				...
				<div class="sixteen columns">
					...
					<div class="feature-description">
						Learn how to write a truly secure node web application.
					</div> <!-- /.feature-description -->
		...
		<div class="container">
			...
			<div class="sixteen columns" style="text-align:center; margin:0 auto; width:100%;">
				...
				<h3 class="title"><span class="title-highlight">Format</span></h3>
 				<p>All code examples are written in JS with accompanying source code on GitHub.</p>
 			</div>

			<div class="sixteen columns" style="text-align:center; margin:0 auto; width:100%;">
				<br /><br />
				<h3 class="title"><span class="title-highlight">~100 Pages</span> of awesome</h3>
 			</div>
	...
	<section id="author" class="author boxed">
		...
		<div class="section-header">
			...
			<p class="description">
				Ben Edmunds is the CTO of an awesome company you've never heard of by day, hacking on crazy ideas by night. PHP Town Hall podcast co-host.  He is an active leader, developer, and speaker in various development communities. He has been developing software professionally for over 10 years and in that time has worked on everything from robotics to government projects.
			</p>
		</div> <!-- /.section-header -->
